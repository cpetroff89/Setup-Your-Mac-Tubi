...
buildingsListRaw="San Francisco
New York City
Chicago
Dallas
Los Angeles
...
departmentListRaw="Acquired Content
Advertising - Chicago
...
supportTeamName="Fox Support"
supportTeamPhone="+1 (887) 369-4357"
supportTeamEmail="techsupport@fox.com"
...
welcomeMessage="Please enter the **required** information for your ${modelName}, then click **Continue** to start applying settings to your new Mac. \n\nOnce completed, the **Wait** button will be enabled and you‘ll be able to review the results before restarting your ${modelName}."
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    },
                    {
                        ...
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_b2f14d19281db623e292ba0e1e68aef0584e3b7e1803bd31b13be6780df7e75b",
                        "progresstext": "Registering Crowdstrike Falcon with the Tubi license..",
                        "trigger_list": [
                                         {
                                            "trigger": "CS-falcon-license",
                                            "validation": "None"
                                         }
                        ]
                    },
                    ...
                    },
                    {
                        ...
                        "trigger_list": [
                                         {
                                            "trigger": "config_desktop_background",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        ...
                        "trigger_list": [
                                         {
                                            "trigger": "slack_notification_new",
                                            "validation": "None"
                                         }
                        ]
                    },
